...
import { domesticPackages, getSightImages } from '../data/packages';
...
export default function UAETours() {
  ...
  return (
    <ScrollReveal>
      <div className="page-domestictours-wrapper bg-white min-h-screen text-black overflow-x-hidden relative" style={{ backgroundColor: "#ffffff", color: "#000000" }}>
            ...
            <div className="internal-hero-container snap-start">
              <div className="internal-hero-bg">
                <img 
                  ...
                  src="https://images.unsplash.com/photo-1599661046289-e31897846e41?q=80&w=1920&auto=format&fit=crop"
                />
              </div>
              ...
              <div className="container mx-auto px-4 h-full relative z-10 flex flex-col items-center justify-center text-center">
                <div className="w-full" style={{"opacity":"1","transform":"none"}}>
                  <h1 className="internal-hero-title">DOMESTIC</h1>
                  <span className="internal-hero-script" style={{"opacity":"0","transform":"translateY(10px)"}}>Explore Bharat</span>
                </div>
              </div>
                ...
                <div className="max-w-7xl mx-auto space-y-12">
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-center gap-6 border-b border-white/10 pb-10">
                    <div className="text-center md:text-left">
                      <span className="text-secondary font-bold tracking-[0.5em] uppercase text-xs mb-3 block">Explore Bharat</span>
                      <h2 className="text-4xl md:text-6xl font-serif font-bold leading-none tracking-tighter uppercase">
                        Domestic <span className="text-secondary italic font-serif">Packages.</span>
                      </h2>
                    </div>
