...
export default function Thailand() {
  ...
  React.useEffect(() => {
    localStorage.setItem('spin_last_viewed', JSON.stringify({
      name: "Thailand",
      image: "https://images.unsplash.com/photo-1528181304800-2f12585c7687?auto=format&fit=crop&w=800&q=80",
      route: "/packages/thailand",
      timestamp: Date.now()
    }));
  }, []);
  ...
  return (
    <ScrollReveal>
      <div className="page-thailand-wrapper bg-black min-h-screen text-white overflow-x-hidden relative">
            ...
            <section className="relative h-[55vh] w-full overflow-hidden">
              ...
              <div className="container mx-auto px-4 h-full relative z-10 flex flex-col justify-end pb-12">
                <div>
                  ...
                  <h1 className="text-4xl md:text-6xl font-serif font-bold mb-4 tracking-tight">Thailand</h1>
                </div>
              </div>
            </section>
            ...
            <div className="container mx-auto px-4 mt-20 grid grid-cols-1 lg:grid-cols-3 gap-16">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="p-10 rounded-[2.5rem] border border-white/10 bg-white/[0.02] backdrop-blur-md shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
                  ...
                  <form onSubmit={(e) => {
                    e.preventDefault();
                    const text = `Hi SPIN Global, I want to book/enquire about the *Thailand* package.
Details:
- *Name*: ${formData.name}
                ...
                <div className="p-8 rounded-[2rem] border border-white/10 bg-white/[0.01]">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="relative pl-12 group">
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-3">Phi Phi Islands</h3>
                        <p className="text-white/50 leading-relaxed font-light">Swim in Maya Bay and explore the legendary turquoise lagoons of Phi Phi.</p>
                      </div>
                    </div>
                    <div className="relative pl-12 group">
                      <div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10 opacity-30"></div>
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-3">Grand Palace, Bangkok</h3>
                        <p className="text-white/50 leading-relaxed font-light">Marvel at the spectacular gold detailing and temples of the Thai royal court.</p>
                      </div>
                    </div>
                    <div className="relative pl-12 group">
                      <div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10 opacity-30"></div>
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-3">Phuket Beaches</h3>
                        <p className="text-white/50 leading-relaxed font-light">Soak up the sun on Patong, Kata, or Karon beaches, enjoying the Andaman sea breeze.</p>
                      </div>
                    </div>
                    <div className="relative pl-12 group">
                      <div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10 opacity-30"></div>
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-3">Chiang Mai Elephant Sanctuary</h3>
                        <p className="text-white/50 leading-relaxed font-light">Interact ethically with rescued elephants in their natural jungle habitat.</p>
                      </div>
                    </div>
                    <div className="relative pl-12 group">
                      <div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10 opacity-30"></div>
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-3">Wat Arun Temple</h3>
                        <p className="text-white/50 leading-relaxed font-light">Admire the stunning porcelain-covered spires of the Temple of Dawn along the river.</p>
                      </div>
                    </div>
                    <div className="relative pl-12 group">
                      <div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10 opacity-30"></div>
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-3">Krabi Railay Beach</h3>
                        <p className="text-white/50 leading-relaxed font-light">Explore secluded beaches accessible only by longtail boat, surrounded by rock walls.</p>
                      </div>
                    </div>
