...
export default function MaldivesEscape() {
  ...
  return (
    <ScrollReveal>
      <div className="page-maldivesescape-wrapper bg-black min-h-screen text-white overflow-x-hidden relative">
            ...
            <section className="relative h-[55vh] w-full overflow-hidden">
              ...
              <div className="container mx-auto px-4 h-full relative z-10 flex flex-col justify-end pb-12">
                <div>
                  ...
                  <h1 className="text-4xl md:text-6xl font-serif font-bold mb-4 tracking-tight">MaldivesEscape</h1>
                </div>
              </div>
            </section>
            ...
            <div className="container mx-auto px-4 mt-20 grid grid-cols-1 lg:grid-cols-3 gap-16">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="p-10 rounded-[2.5rem] border border-white/10 bg-white/[0.02] backdrop-blur-md shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
                  ...
                  <form onSubmit={(e) => {
                    e.preventDefault();
                    const text = `Hi SPIN Global, I want to book/enquire about the *MaldivesEscape* package.
Details:
- *Name*: ${formData.name}
...
- *Message*: ${formData.message || 'None'}`;
                ...
                {/* Inclusions and Exclusions */}
                  ...
                  <section className="grid grid-cols-1 md:grid-cols-2 gap-12 pt-12 border-t border-white/5">
                    <div className="space-y-8"><div className="flex items-center gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-circle-check text-emerald-500" aria-hidden="true"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg><h3 className="text-xl font-bold uppercase tracking-widest">Inclusions</h3></div><ul className="space-y-4"><li className="text-white/60 flex items-center gap-3"><div className="w-1.5 h-1.5 rounded-full bg-emerald-500/50"></div>Resort Stay</li><li className="text-white/60 flex items-center gap-3"><div className="w-1.5 h-1.5 rounded-full bg-emerald-500/50"></div>Speedboat Transfers</li><li className="text-white/60 flex items-center gap-3"><div className="w-1.5 h-1.5 rounded-full bg-emerald-500/50"></div>All Meals</li></ul></div><div className="space-y-8"><div className="flex items-center gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-circle-x text-rose-500" aria-hidden="true"><circle cx="12" cy="12" r="10"></circle><path d="m15 9-6 6"></path><path d="m9 9 6 6"></path></svg><h3 className="text-xl font-bold uppercase tracking-widest">Exclusions</h3></div><ul className="space-y-4"><li className="text-white/40 flex items-center gap-3"><div className="w-1.5 h-1.5 rounded-full bg-rose-500/30"></div>International Flights</li><li className="text-white/40 flex items-center gap-3"><div className="w-1.5 h-1.5 rounded-full bg-rose-500/30"></div>Optional Excursions</li><li className="text-white/40 flex items-center gap-3"><div className="w-1.5 h-1.5 rounded-full bg-rose-500/30"></div>Premium Spirits</li></ul></div>
                  </section>
              </div>
              ...
              <div className="lg:col-span-1 space-y-12">
                ...
                <div className="p-8 rounded-[2rem] border border-white/10 bg-white/[0.01]">
                  ...
                  <div className="space-y-6">
                    <div className="relative pl-12 group"><div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10"></div><div className="absolute left-0 top-0 w-8 h-8 rounded-full bg-secondary/10 border border-secondary/30 flex items-center justify-center group-hover:bg-secondary group-hover:text-black transition-all"><span className="text-xs font-bold">1</span></div><div><h3 className="text-xl font-bold mb-3">Day 1: Welcome to Paradise</h3><p className="text-white/50 leading-relaxed font-light">Arrive at Male Airport and transfer to your luxury resort via speedboat. Enjoy your first Maldivian sunset.</p></div></div><div className="relative pl-12 group"><div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10"></div><div className="absolute left-0 top-0 w-8 h-8 rounded-full bg-secondary/10 border border-secondary/30 flex items-center justify-center group-hover:bg-secondary group-hover:text-black transition-all"><span className="text-xs font-bold">2</span></div><div><h3 className="text-xl font-bold mb-3">Day 2: Ocean Exploration</h3><p className="text-white/50 leading-relaxed font-light">Start your day with a guided snorkeling session in the house reef. Discover vibrant coral lives and exotic fish.</p></div></div><div className="relative pl-12 group"><div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10"></div><div className="absolute left-0 top-0 w-8 h-8 rounded-full bg-secondary/10 border border-secondary/30 flex items-center justify-center group-hover:bg-secondary group-hover:text-black transition-all"><span className="text-xs font-bold">3</span></div><div><h3 className="text-xl font-bold mb-3">Day 3: Sandbank Picnic</h3><p className="text-white/50 leading-relaxed font-light">Private boat trip to a secluded sandbank for a gourmet picnic and relaxation in the sun.</p></div></div><div className="relative pl-12 group"><div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10"></div><div className="absolute left-0 top-0 w-8 h-8 rounded-full bg-secondary/10 border border-secondary/30 flex items-center justify-center group-hover:bg-secondary group-hover:text-black transition-all"><span className="text-xs font-bold">4</span></div><div><h3 className="text-xl font-bold mb-3">Day 4: Spa &amp; Sunset Cruise</h3><p className="text-white/50 leading-relaxed font-light">Indulge in a signature overwater spa treatment. Cap off the day with a romantic sunset dolphin cruise.</p></div></div><div className="relative pl-12 group"><div className="absolute left-0 top-0 w-8 h-8 rounded-full bg-secondary/10 border border-secondary/30 flex items-center justify-center group-hover:bg-secondary group-hover:text-black transition-all"><span className="text-xs font-bold">5</span></div><div><h3 className="text-xl font-bold mb-3">Day 5: Leisure &amp; Farewell</h3><p className="text-white/50 leading-relaxed font-light">Morning at leisure for final swim or souvenir shopping before transferring back to Male Airport.</p></div></div>
                  </div>
                </div>
                ...
                <div className="p-8 rounded-[2rem] border border-white/10 bg-white/[0.01]">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    <div className="relative h-20 rounded-xl overflow-hidden border border-white/10 shadow group/gal cursor-pointer">
                      <img alt="Sight 1" className="object-cover w-full h-full group-hover/gal:scale-110 transition-transform duration-500" src="https://images.unsplash.com/photo-1514282401047-d79a71a590e8?auto=format&fit=crop&w=400&q=80" />
                    </div>
                    <div className="relative h-20 rounded-xl overflow-hidden border border-white/10 shadow group/gal cursor-pointer">
                      <img alt="Sight 2" className="object-cover w-full h-full group-hover/gal:scale-110 transition-transform duration-500" src="https://images.unsplash.com/photo-1439066615861-d1af74d74000?auto=format&fit=crop&w=400&q=80" />
                    </div>
                    <div className="relative h-20 rounded-xl overflow-hidden border border-white/10 shadow group/gal cursor-pointer">
                      <img alt="Sight 3" className="object-cover w-full h-full group-hover/gal:scale-110 transition-transform duration-500" src="https://images.unsplash.com/photo-1506929562872-bb421503ef21?auto=format&fit=crop&w=400&q=80" />
                    </div>
                  </div>
                </div>
