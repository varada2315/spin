...
export default function DubaiGrand() {
  ...
  return (
    <ScrollReveal>
      <div className="page-dubaigrand-wrapper bg-black min-h-screen text-white overflow-x-hidden relative">
            ...
            <section className="relative h-[55vh] w-full overflow-hidden">
              ...
              <div className="container mx-auto px-4 h-full relative z-10 flex flex-col justify-end pb-12">
                <div>
                  ...
                  <h1 className="text-4xl md:text-6xl font-serif font-bold mb-4 tracking-tight">DubaiGrand</h1>
                </div>
              </div>
            </section>
            ...
            <div className="container mx-auto px-4 mt-20 grid grid-cols-1 lg:grid-cols-3 gap-16">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="p-10 rounded-[2.5rem] border border-white/10 bg-white/[0.02] backdrop-blur-md shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
                  ...
                  <form onSubmit={(e) => {
                    e.preventDefault();
                    const text = `Hi SPIN Global, I want to book/enquire about the *DubaiGrand* package.
Details:
- *Name*: ${formData.name}
...
- *Message*: ${formData.message || 'None'}`;
                ...
                {/* Inclusions and Exclusions */}
                  ...
                  <section className="grid grid-cols-1 md:grid-cols-2 gap-12 pt-12 border-t border-white/5">
                    <div className="space-y-8"><div className="flex items-center gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-circle-check text-emerald-500" aria-hidden="true"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg><h3 className="text-xl font-bold uppercase tracking-widest">Inclusions</h3></div><ul className="space-y-4"><li className="text-white/60 flex items-center gap-3"><div className="w-1.5 h-1.5 rounded-full bg-emerald-500/50"></div>5* Hotel</li><li className="text-white/60 flex items-center gap-3"><div className="w-1.5 h-1.5 rounded-full bg-emerald-500/50"></div>Private Guide</li><li className="text-white/60 flex items-center gap-3"><div className="w-1.5 h-1.5 rounded-full bg-emerald-500/50"></div>All Entry Tickets</li></ul></div><div className="space-y-8"><div className="flex items-center gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-circle-x text-rose-500" aria-hidden="true"><circle cx="12" cy="12" r="10"></circle><path d="m15 9-6 6"></path><path d="m9 9 6 6"></path></svg><h3 className="text-xl font-bold uppercase tracking-widest">Exclusions</h3></div><ul className="space-y-4"><li className="text-white/40 flex items-center gap-3"><div className="w-1.5 h-1.5 rounded-full bg-rose-500/30"></div>PCR Tests (if required)</li><li className="text-white/40 flex items-center gap-3"><div className="w-1.5 h-1.5 rounded-full bg-rose-500/30"></div>Travel Insurance</li><li className="text-white/40 flex items-center gap-3"><div className="w-1.5 h-1.5 rounded-full bg-rose-500/30"></div>Minibar usage</li></ul></div>
                  </section>
              </div>
              ...
              <div className="lg:col-span-1 space-y-12">
                ...
                <div className="p-8 rounded-[2rem] border border-white/10 bg-white/[0.01]">
                  ...
                  <div className="space-y-6">
                    <div className="relative pl-12 group"><div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10"></div><div className="absolute left-0 top-0 w-8 h-8 rounded-full bg-secondary/10 border border-secondary/30 flex items-center justify-center group-hover:bg-secondary group-hover:text-black transition-all"><span className="text-xs font-bold">1</span></div><div><h3 className="text-xl font-bold mb-3">Day 1: Arrival &amp; Dubai Frame</h3><p className="text-white/50 leading-relaxed font-light">Welcome to Dubai! Check into your 5-star hotel and visit the iconic Dubai Frame in the evening.</p></div></div><div className="relative pl-12 group"><div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10"></div><div className="absolute left-0 top-0 w-8 h-8 rounded-full bg-secondary/10 border border-secondary/30 flex items-center justify-center group-hover:bg-secondary group-hover:text-black transition-all"><span className="text-xs font-bold">2</span></div><div><h3 className="text-xl font-bold mb-3">Day 2: Modern Dubai &amp; Museum of Future</h3><p className="text-white/50 leading-relaxed font-light">Explore the Museum of the Future followed by a visit to the Sky Views Observatory for stunning city vistas.</p></div></div><div className="relative pl-12 group"><div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10"></div><div className="absolute left-0 top-0 w-8 h-8 rounded-full bg-secondary/10 border border-secondary/30 flex items-center justify-center group-hover:bg-secondary group-hover:text-black transition-all"><span className="text-xs font-bold">3</span></div><div><h3 className="text-xl font-bold mb-3">Day 3: Miracle Garden &amp; Global Village</h3><p className="text-white/50 leading-relaxed font-light">Walk through the world&#x27;s largest natural flower garden and spend the evening exploring cultures at Global Village.</p></div></div><div className="relative pl-12 group"><div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10"></div><div className="absolute left-0 top-0 w-8 h-8 rounded-full bg-secondary/10 border border-secondary/30 flex items-center justify-center group-hover:bg-secondary group-hover:text-black transition-all"><span className="text-xs font-bold">4</span></div><div><h3 className="text-xl font-bold mb-3">Day 4: Free Day for Leisure</h3><p className="text-white/50 leading-relaxed font-light">Enjoy the hotel amenities or head to Dubai Mall for some high-end shopping.</p></div></div><div className="relative pl-12 group"><div className="absolute left-0 top-0 w-8 h-8 rounded-full bg-secondary/10 border border-secondary/30 flex items-center justify-center group-hover:bg-secondary group-hover:text-black transition-all"><span className="text-xs font-bold">5</span></div><div><h3 className="text-xl font-bold mb-3">Day 5: Departure</h3><p className="text-white/50 leading-relaxed font-light">A final luxury breakfast before your private transfer to the airport.</p></div></div>
                  </div>
                </div>
