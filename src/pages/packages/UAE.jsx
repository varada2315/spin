...
export default function UAE() {
  ...
  return (
    <ScrollReveal>
      <div className="page-uae-wrapper bg-black min-h-screen text-white overflow-x-hidden relative">
            ...
            <section className="relative h-[55vh] w-full overflow-hidden">
              ...
              <div className="container mx-auto px-4 h-full relative z-10 flex flex-col justify-end pb-12">
                <div>
                  ...
                  <h1 className="text-4xl md:text-6xl font-serif font-bold mb-4 tracking-tight">UAE</h1>
                </div>
              </div>
            </section>
            ...
            <div className="container mx-auto px-4 mt-20 grid grid-cols-1 lg:grid-cols-3 gap-16">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="p-10 rounded-[2.5rem] border border-white/10 bg-white/[0.02] backdrop-blur-md shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
                  ...
                  <form onSubmit={(e) => {
                    e.preventDefault();
                    const text = `Hi SPIN Global, I want to book/enquire about the *UAE* package.
Details:
- *Name*: ${formData.name}
                ...
                <div className="p-8 rounded-[2rem] border border-white/10 bg-white/[0.01]">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="relative pl-12 group">
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-3">Burj Khalifa</h3>
                        <p className="text-white/50 leading-relaxed font-light">Ascend the tallest building in the world for an unmatched bird's-eye view of Dubai's skyline.</p>
                      </div>
                    </div>
                    <div className="relative pl-12 group">
                      <div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10 opacity-30"></div>
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-3">Dubai Desert Safari</h3>
                        <p className="text-white/50 leading-relaxed font-light">Enjoy dune bashing, camel riding, and a traditional dinner show under the stars.</p>
                      </div>
                    </div>
                    <div className="relative pl-12 group">
                      <div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10 opacity-30"></div>
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-3">Palm Jumeirah & Atlantis</h3>
                        <p className="text-white/50 leading-relaxed font-light">Explore the man-made palm island and the luxurious Atlantis resort landscape.</p>
                      </div>
                    </div>
                    <div className="relative pl-12 group">
                      <div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10 opacity-30"></div>
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-3">Sheikh Zayed Grand Mosque (Abu Dhabi)</h3>
                        <p className="text-white/50 leading-relaxed font-light">Admire the pure white marble, massive domes, and exquisite chandeliers of this architectural masterpiece.</p>
                      </div>
                    </div>
                    <div className="relative pl-12 group">
                      <div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10 opacity-30"></div>
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-3">Dubai Marina & Global Village</h3>
                        <p className="text-white/50 leading-relaxed font-light">Stroll past superyachts and experience cultural pavilions from around the globe.</p>
                      </div>
                    </div>
                    <div className="relative pl-12 group">
                      <div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10 opacity-30"></div>
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-3">Ferrari World / Yas Island</h3>
                        <p className="text-white/50 leading-relaxed font-light">Ride the world's fastest roller coaster and explore the high-speed thrill park.</p>
                      </div>
                    </div>
