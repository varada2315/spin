...
export default function SaudiArabia() {
  ...
  React.useEffect(() => {
    localStorage.setItem('spin_last_viewed', JSON.stringify({
      name: "Saudi Arabia",
      image: "https://images.unsplash.com/photo-1586724237569-f38559db835b?auto=format&fit=crop&w=800&q=80",
      route: "/packages/saudi-arabia",
      timestamp: Date.now()
    }));
  }, []);
  ...
  return (
    <ScrollReveal>
      <div className="page-saudiarabia-wrapper bg-black min-h-screen text-white overflow-x-hidden relative">
            ...
            <section className="relative h-[55vh] w-full overflow-hidden">
              ...
              <div className="container mx-auto px-4 h-full relative z-10 flex flex-col justify-end pb-12">
                <div>
                  ...
                  <h1 className="text-4xl md:text-6xl font-serif font-bold mb-4 tracking-tight">SaudiArabia</h1>
                </div>
              </div>
            </section>
            ...
            <div className="container mx-auto px-4 mt-20 grid grid-cols-1 lg:grid-cols-3 gap-16">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="p-10 rounded-[2.5rem] border border-white/10 bg-white/[0.02] backdrop-blur-md shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
                  ...
                  <form onSubmit={(e) => {
                    e.preventDefault();
                    const text = `Hi SPIN Global, I want to book/enquire about the *SaudiArabia* package.
Details:
- *Name*: ${formData.name}
                ...
                <div className="p-8 rounded-[2rem] border border-white/10 bg-white/[0.01]">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="relative pl-12 group">
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-3">AlUla / Hegra Rock Tombs</h3>
                        <p className="text-white/50 leading-relaxed font-light">Explore the ancient Nabataean tombs carved into sandstone mountains.</p>
                      </div>
                    </div>
                    <div className="relative pl-12 group">
                      <div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10 opacity-30"></div>
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-3">Masjid al-Haram, Mecca (Umrah)</h3>
                        <p className="text-white/50 leading-relaxed font-light">Perform the holy pilgrimage of Umrah at the sacred Kaaba.</p>
                      </div>
                    </div>
                    <div className="relative pl-12 group">
                      <div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10 opacity-30"></div>
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-3">Red Sea Coast</h3>
                        <p className="text-white/50 leading-relaxed font-light">Dive into pristine coral reefs and enjoy untouched beach resorts.</p>
                      </div>
                    </div>
                    <div className="relative pl-12 group">
                      <div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10 opacity-30"></div>
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-3">Riyadh Edge of the World</h3>
                        <p className="text-white/50 leading-relaxed font-light">Stand atop towering cliffs offering infinite views of desert horizons.</p>
                      </div>
                    </div>
                    <div className="relative pl-12 group">
                      <div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10 opacity-30"></div>
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-3">Diriyah Historic District</h3>
                        <p className="text-white/50 leading-relaxed font-light">Discover the birthplace of the kingdom built in mud-brick architecture.</p>
                      </div>
                    </div>
                    <div className="relative pl-12 group">
                      <div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10 opacity-30"></div>
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-3">NEOM & Modern Developments</h3>
                        <p className="text-white/50 leading-relaxed font-light">Learn about the futuristic cities and mega-projects of Saudi Arabia.</p>
                      </div>
                    </div>
                ...
                <div className="p-8 rounded-[2rem] border border-white/10 bg-white/[0.01]">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    <div className="relative h-20 rounded-xl overflow-hidden border border-white/10 shadow group/gal cursor-pointer">
                      <img alt="Sight 1" className="object-cover w-full h-full group-hover/gal:scale-110 transition-transform duration-500" src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=400&q=80" />
                    </div>
                    <div className="relative h-20 rounded-xl overflow-hidden border border-white/10 shadow group/gal cursor-pointer">
