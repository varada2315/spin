...
export default function LehLadakh() {
  ...
  return (
    <ScrollReveal>
      <div className="page-lehladakh-wrapper bg-black min-h-screen text-white overflow-x-hidden relative">
            ...
            <section className="relative h-[55vh] w-full overflow-hidden">
              ...
              <div className="container mx-auto px-4 h-full relative z-10 flex flex-col justify-end pb-12">
                <div>
                  ...
                  <h1 className="text-4xl md:text-6xl font-serif font-bold mb-4 tracking-tight">LehLadakh</h1>
                </div>
              </div>
            </section>
            ...
            <div className="container mx-auto px-4 mt-20 grid grid-cols-1 lg:grid-cols-3 gap-16">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="p-10 rounded-[2.5rem] border border-white/10 bg-white/[0.02] backdrop-blur-md shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
                  ...
                  <form onSubmit={(e) => {
                    e.preventDefault();
                    const text = `Hi SPIN Global, I want to book/enquire about the *LehLadakh* package.
Details:
- *Name*: ${formData.name}
                ...
                <div className="p-8 rounded-[2rem] border border-white/10 bg-white/[0.01]">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="relative pl-12 group">
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-3">Pangong Lake</h3>
                        <p className="text-white/50 leading-relaxed font-light">Marvel at the high-altitude lake that changes colors from blue to green to grey.</p>
                      </div>
                    </div>
                    <div className="relative pl-12 group">
                      <div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10 opacity-30"></div>
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-3">Nubra Valley Sand Dunes</h3>
                        <p className="text-white/50 leading-relaxed font-light">Ride double-humped Bactrian camels on high-altitude sand dunes.</p>
                      </div>
                    </div>
                    <div className="relative pl-12 group">
                      <div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10 opacity-30"></div>
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-3">Khardung La Pass</h3>
                        <p className="text-white/50 leading-relaxed font-light">Stand at one of the highest motorable mountain passes in the world.</p>
                      </div>
                    </div>
                    <div className="relative pl-12 group">
                      <div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10 opacity-30"></div>
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-3">Magnetic Hill</h3>
                        <p className="text-white/50 leading-relaxed font-light">Witness the optical illusion where vehicles appear to roll uphill on their own.</p>
                      </div>
                    </div>
                    <div className="relative pl-12 group">
                      <div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10 opacity-30"></div>
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-3">Thiksey Monastery</h3>
                        <p className="text-white/50 leading-relaxed font-light">Tour the twelve-story monastery complex resembling the Potala Palace.</p>
                      </div>
                    </div>
                    <div className="relative pl-12 group">
                      <div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10 opacity-30"></div>
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-3">Zanskar Valley / Chadar Trek</h3>
                        <p className="text-white/50 leading-relaxed font-light">Walk along the frozen river trek surrounded by vertical cliffs.</p>
                      </div>
                    </div>
                ...
                <div className="p-8 rounded-[2rem] border border-white/10 bg-white/[0.01]">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    <div className="relative h-20 rounded-xl overflow-hidden border border-white/10 shadow group/gal cursor-pointer">
                      <img alt="Sight 1" className="object-cover w-full h-full group-hover/gal:scale-110 transition-transform duration-500" src="https://images.unsplash.com/photo-1599661046289-e31897846e41?auto=format&fit=crop&w=400&q=80" />
                    </div>
                    <div className="relative h-20 rounded-xl overflow-hidden border border-white/10 shadow group/gal cursor-pointer">
                      <img alt="Sight 2" className="object-cover w-full h-full group-hover/gal:scale-110 transition-transform duration-500" src="https://images.unsplash.com/photo-1581793745862-99fde7fa73d2?auto=format&fit=crop&w=400&q=80" />
                    </div>
                    <div className="relative h-20 rounded-xl overflow-hidden border border-white/10 shadow group/gal cursor-pointer">
                      <img alt="Sight 3" className="object-cover w-full h-full group-hover/gal:scale-110 transition-transform duration-500" src="https://images.unsplash.com/photo-1626493963968-3d1f0cc3d376?auto=format&fit=crop&w=400&q=80" />
                    </div>
                  </div>
                </div>
