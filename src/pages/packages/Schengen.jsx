...
export default function Schengen() {
  ...
  return (
    <ScrollReveal>
      <div className="page-schengen-wrapper bg-black min-h-screen text-white overflow-x-hidden relative">
            ...
            <section className="relative h-[55vh] w-full overflow-hidden">
              ...
              <div className="container mx-auto px-4 h-full relative z-10 flex flex-col justify-end pb-12">
                <div>
                  ...
                  <h1 className="text-4xl md:text-6xl font-serif font-bold mb-4 tracking-tight">Schengen</h1>
                </div>
              </div>
            </section>
            ...
            <div className="container mx-auto px-4 mt-20 grid grid-cols-1 lg:grid-cols-3 gap-16">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="p-10 rounded-[2.5rem] border border-white/10 bg-white/[0.02] backdrop-blur-md shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
                  ...
                  <form onSubmit={(e) => {
                    e.preventDefault();
                    const text = `Hi SPIN Global, I want to book/enquire about the *Schengen* package.
Details:
- *Name*: ${formData.name}
                ...
                <div className="p-8 rounded-[2rem] border border-white/10 bg-white/[0.01]">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="relative pl-12 group">
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-3">Eiffel Tower, Paris</h3>
                        <p className="text-white/50 leading-relaxed font-light">Ascend the iconic wrought-iron tower for a classic view of the City of Light.</p>
                      </div>
                    </div>
                    <div className="relative pl-12 group">
                      <div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10 opacity-30"></div>
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-3">Swiss Alps (Interlaken / Jungfrau)</h3>
                        <p className="text-white/50 leading-relaxed font-light">Board a cogwheel train to the Top of Europe, surrounded by glaciers.</p>
                      </div>
                    </div>
                    <div className="relative pl-12 group">
                      <div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10 opacity-30"></div>
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-3">Venice Canals</h3>
                        <p className="text-white/50 leading-relaxed font-light">Take a traditional gondola ride through the narrow waterways and bridges of Venice.</p>
                      </div>
                    </div>
                    <div className="relative pl-12 group">
                      <div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10 opacity-30"></div>
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-3">Santorini, Greece</h3>
                        <p className="text-white/50 leading-relaxed font-light">Watch the sunset over white-washed buildings and blue domes in the Aegean Sea.</p>
                      </div>
                    </div>
                    <div className="relative pl-12 group">
                      <div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10 opacity-30"></div>
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-3">Neuschwanstein Castle, Germany</h3>
                        <p className="text-white/50 leading-relaxed font-light">Tour the fairytale castle nestled in the Bavarian Alps that inspired Disney.</p>
                      </div>
                    </div>
                    <div className="relative pl-12 group">
                      <div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10 opacity-30"></div>
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-3">Amsterdam Canals</h3>
                        <p className="text-white/50 leading-relaxed font-light">Take a scenic boat cruise through the historic canal ring of Amsterdam.</p>
                      </div>
                    </div>
