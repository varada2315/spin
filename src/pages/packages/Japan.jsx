...
export default function Japan() {
  ...
  return (
    <ScrollReveal>
      <div className="page-japan-wrapper bg-black min-h-screen text-white overflow-x-hidden relative">
            ...
            <section className="relative h-[55vh] w-full overflow-hidden">
              ...
              <div className="container mx-auto px-4 h-full relative z-10 flex flex-col justify-end pb-12">
                <div>
                  ...
                  <h1 className="text-4xl md:text-6xl font-serif font-bold mb-4 tracking-tight">Japan</h1>
                </div>
              </div>
            </section>
            ...
            <div className="container mx-auto px-4 mt-20 grid grid-cols-1 lg:grid-cols-3 gap-16">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="p-10 rounded-[2.5rem] border border-white/10 bg-white/[0.02] backdrop-blur-md shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
                  ...
                  <form onSubmit={(e) => {
                    e.preventDefault();
                    const text = `Hi SPIN Global, I want to book/enquire about the *Japan* package.
Details:
- *Name*: ${formData.name}
                ...
                <div className="p-8 rounded-[2rem] border border-white/10 bg-white/[0.01]">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="relative pl-12 group">
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-3">Mount Fuji</h3>
                        <p className="text-white/50 leading-relaxed font-light">Admire the snow-capped volcanic peak of Japan's most sacred mountain.</p>
                      </div>
                    </div>
                    <div className="relative pl-12 group">
                      <div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10 opacity-30"></div>
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-3">Kyoto Fushimi Inari Shrine</h3>
                        <p className="text-white/50 leading-relaxed font-light">Walk through thousands of vibrant orange torii gates leading up the mountain.</p>
                      </div>
                    </div>
                    <div className="relative pl-12 group">
                      <div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10 opacity-30"></div>
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-3">Tokyo Shibuya Crossing & Skytree</h3>
                        <p className="text-white/50 leading-relaxed font-light">Experience the world's busiest pedestrian crossing and ascend the giant tower.</p>
                      </div>
                    </div>
                    <div className="relative pl-12 group">
                      <div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10 opacity-30"></div>
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-3">Osaka Castle</h3>
                        <p className="text-white/50 leading-relaxed font-light">Explore the historic fortress surrounded by cherry blossoms and deep moats.</p>
                      </div>
                    </div>
                    <div className="relative pl-12 group">
                      <div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10 opacity-30"></div>
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-3">Arashiyama Bamboo Grove</h3>
                        <p className="text-white/50 leading-relaxed font-light">Stroll through towering green bamboo stalks that whisper in the wind.</p>
                      </div>
                    </div>
                    <div className="relative pl-12 group">
                      <div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10 opacity-30"></div>
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-3">Cherry Blossom Parks (seasonal)</h3>
                        <p className="text-white/50 leading-relaxed font-light">Participate in hanami, the traditional custom of enjoying the transient beauty of cherry blossoms.</p>
                      </div>
                    </div>
                ...
                <div className="p-8 rounded-[2rem] border border-white/10 bg-white/[0.01]">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    <div className="relative h-20 rounded-xl overflow-hidden border border-white/10 shadow group/gal cursor-pointer">
                      <img alt="Sight 1" className="object-cover w-full h-full group-hover/gal:scale-110 transition-transform duration-500" src="https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?auto=format&fit=crop&w=400&q=80" />
                    </div>
                    <div className="relative h-20 rounded-xl overflow-hidden border border-white/10 shadow group/gal cursor-pointer">
                      <img alt="Sight 2" className="object-cover w-full h-full group-hover/gal:scale-110 transition-transform duration-500" src="https://images.unsplash.com/photo-1490730141103-6cac27aaab94?auto=format&fit=crop&w=400&q=80" />
                    </div>
                    <div className="relative h-20 rounded-xl overflow-hidden border border-white/10 shadow group/gal cursor-pointer">
                      <img alt="Sight 3" className="object-cover w-full h-full group-hover/gal:scale-110 transition-transform duration-500" src="https://images.unsplash.com/photo-1503899036084-c55cdd92da26?auto=format&fit=crop&w=400&q=80" />
                    </div>
                  </div>
                </div>
