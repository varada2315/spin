...
export default function ThaiAdventures() {
  ...
  return (
    <ScrollReveal>
      <div className="page-thaiadventures-wrapper bg-black min-h-screen text-white overflow-x-hidden relative">
            ...
            <section className="relative h-[55vh] w-full overflow-hidden">
              <div className="absolute inset-0" style={{transform:"scale(1.1)"}}>
                <img 
                  ...
                  src="https://images.unsplash.com/photo-1528181304800-2f190854897d?auto=format&fit=crop&w=400&q=80"
                />
              </div>
              <div className="container mx-auto px-4 h-full relative z-10 flex flex-col justify-end pb-12">
                <div>
                  ...
                  <h1 className="text-4xl md:text-6xl font-serif font-bold mb-4 tracking-tight">ThaiAdventures</h1>
                </div>
              </div>
            </section>
            ...
            <div className="container mx-auto px-4 mt-20 grid grid-cols-1 lg:grid-cols-3 gap-16">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div className="p-10 rounded-[2.5rem] border border-white/10 bg-white/[0.02] backdrop-blur-md shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
                  ...
                  <form onSubmit={(e) => {
                    e.preventDefault();
                    const text = `Hi SPIN Global, I want to book/enquire about the *ThaiAdventures* package.
Details:
- *Name*: ${formData.name}
...
- *Message*: ${formData.message || 'None'}`;
                ...
                {/* Inclusions and Exclusions */}
                  ...
                  <section className="grid grid-cols-1 md:grid-cols-2 gap-12 pt-12 border-t border-white/5">
                    <div className="space-y-8"><div className="flex items-center gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-circle-check text-emerald-500" aria-hidden="true"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg><h3 className="text-xl font-bold uppercase tracking-widest">Inclusions</h3></div><ul className="space-y-4"><li className="text-white/60 flex items-center gap-3"><div className="w-1.5 h-1.5 rounded-full bg-emerald-500/50"></div>Hotels</li><li className="text-white/60 flex items-center gap-3"><div className="w-1.5 h-1.5 rounded-full bg-emerald-500/50"></div>Internal Flights</li><li className="text-white/60 flex items-center gap-3"><div className="w-1.5 h-1.5 rounded-full bg-emerald-500/50"></div>Guided Tours</li></ul></div><div className="space-y-8"><div className="flex items-center gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-circle-x text-rose-500" aria-hidden="true"><circle cx="12" cy="12" r="10"></circle><path d="m15 9-6 6"></path><path d="m9 9 6 6"></path></svg><h3 className="text-xl font-bold uppercase tracking-widest">Exclusions</h3></div><ul className="space-y-4"><li className="text-white/40 flex items-center gap-3"><div className="w-1.5 h-1.5 rounded-full bg-rose-500/30"></div>Visa on Arrival fees</li><li className="text-white/40 flex items-center gap-3"><div className="w-1.5 h-1.5 rounded-full bg-rose-500/30"></div>Personal shopping</li><li className="text-white/40 flex items-center gap-3"><div className="w-1.5 h-1.5 rounded-full bg-rose-500/30"></div>Optional activities</li></ul></div>
                  </section>
              </div>
              ...
              <div className="lg:col-span-1 space-y-12">
                ...
                <div className="p-8 rounded-[2rem] border border-white/10 bg-white/[0.01]">
                  ...
                  <div className="space-y-6">
                    <div className="relative pl-12 group"><div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10"></div><div className="absolute left-0 top-0 w-8 h-8 rounded-full bg-secondary/10 border border-secondary/30 flex items-center justify-center group-hover:bg-secondary group-hover:text-black transition-all"><span className="text-xs font-bold">1</span></div><div><h3 className="text-xl font-bold mb-3">Day 1: Bangkok Arrival</h3><p className="text-white/50 leading-relaxed font-light">Explore the vibrant streets of Bangkok. Evening welcome dinner by the river.</p></div></div><div className="relative pl-12 group"><div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10"></div><div className="absolute left-0 top-0 w-8 h-8 rounded-full bg-secondary/10 border border-secondary/30 flex items-center justify-center group-hover:bg-secondary group-hover:text-black transition-all"><span className="text-xs font-bold">2</span></div><div><h3 className="text-xl font-bold mb-3">Day 2: Temples &amp; Grand Palace</h3><p className="text-white/50 leading-relaxed font-light">Visit Wat Phra Kaew, Wat Pho, and the majestic Grand Palace with an expert local guide.</p></div></div><div className="relative pl-12 group"><div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10"></div><div className="absolute left-0 top-0 w-8 h-8 rounded-full bg-secondary/10 border border-secondary/30 flex items-center justify-center group-hover:bg-secondary group-hover:text-black transition-all"><span className="text-xs font-bold">3</span></div><div><h3 className="text-xl font-bold mb-3">Day 3: Street Food Tour</h3><p className="text-white/50 leading-relaxed font-light">A culinary journey through Bangkok&#x27;s famous street food stalls. Transfer to Phuket in the evening.</p></div></div><div className="relative pl-12 group"><div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10"></div><div className="absolute left-0 top-0 w-8 h-8 rounded-full bg-secondary/10 border border-secondary/30 flex items-center justify-center group-hover:bg-secondary group-hover:text-black transition-all"><span className="text-xs font-bold">4</span></div><div><h3 className="text-xl font-bold mb-3">Day 4: Phuket Beach Day</h3><p className="text-white/50 leading-relaxed font-light">Relax at Patong Beach or explore the quieter Kata Noi. Optional Thai massage on the beach.</p></div></div><div className="relative pl-12 group"><div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10"></div><div className="absolute left-0 top-0 w-8 h-8 rounded-full bg-secondary/10 border border-secondary/30 flex items-center justify-center group-hover:bg-secondary group-hover:text-black transition-all"><span className="text-xs font-bold">5</span></div><div><h3 className="text-xl font-bold mb-3">Day 5: Phi Phi Island Hopping</h3><p className="text-white/50 leading-relaxed font-light">Full-day speedboat tour to Phi Phi Islands, Maya Bay, and Pileh Lagoon. Snorkeling included.</p></div></div><div className="relative pl-12 group"><div className="absolute left-[15px] top-10 bottom-[-48px] w-px bg-white/10"></div><div className="absolute left-0 top-0 w-8 h-8 rounded-full bg-secondary/10 border border-secondary/30 flex items-center justify-center group-hover:bg-secondary group-hover:text-black transition-all"><span className="text-xs font-bold">6</span></div><div><h3 className="text-xl font-bold mb-3">Day 6: Old Phuket Town</h3><p className="text-white/50 leading-relaxed font-light">Discover the Sino-Portuguese architecture and vibrant markets of Phuket Old Town.</p></div></div><div className="relative pl-12 group"><div className="absolute left-0 top-0 w-8 h-8 rounded-full bg-secondary/10 border border-secondary/30 flex items-center justify-center group-hover:bg-secondary group-hover:text-black transition-all"><span className="text-xs font-bold">7</span></div><div><h3 className="text-xl font-bold mb-3">Day 7: Departure</h3><p className="text-white/50 leading-relaxed font-light">Morning for last-minute shopping at Central Phuket before transferring to the airport.</p></div></div>
                  </div>
                </div>
                ...
                <div className="p-8 rounded-[2rem] border border-white/10 bg-white/[0.01]">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    <div className="relative h-20 rounded-xl overflow-hidden border border-white/10 shadow group/gal cursor-pointer">
                      <img alt="Sight 1" className="object-cover w-full h-full group-hover/gal:scale-110 transition-transform duration-500" src="https://images.unsplash.com/photo-1528181304800-2f190854897d?auto=format&fit=crop&w=400&q=80" />
                    </div>
                    <div className="relative h-20 rounded-xl overflow-hidden border border-white/10 shadow group/gal cursor-pointer">
                      <img alt="Sight 2" className="object-cover w-full h-full group-hover/gal:scale-110 transition-transform duration-500" src="https://images.unsplash.com/photo-1552465011-b4e21bf6e79a?auto=format&fit=crop&w=400&q=80" />
                    </div>
                    <div className="relative h-20 rounded-xl overflow-hidden border border-white/10 shadow group/gal cursor-pointer">
                      <img alt="Sight 3" className="object-cover w-full h-full group-hover/gal:scale-110 transition-transform duration-500" src="https://images.unsplash.com/photo-1506973035872-a4ec16b8e8d9?auto=format&fit=crop&w=400&q=80" />
                    </div>
                  </div>
                </div>
